...
def run_cascades(node_to_remove,NN):
    ...
    finput_net1 = "NetworkTopologies/network_airports.neighbors"
    finput_net2 = "NetworkTopologies/network_airports.edgelist"
    alpha = 0.0  # Tolerance
